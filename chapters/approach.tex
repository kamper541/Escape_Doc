...
โครงงานนี้ใช้ design pattern MVC~\cite{mvc} และ\CIreply{ทำไมเป็นคำว่า ``และ''} แบ่งออกเป็น 3 ส่วนหลักๆ คือ model, view และ controller
\begin{figure}
\begin{center}
...
\subsection{Model}
 ในส่วนของ Model จะเป็นการจัดการพวก event ต่างๆ ว่าจะให้ event อะไรนั้นเกิดขึ้น\CIreply{แปลว่าอะไร}
...
Unity เช่นกัน เพราะ View ใช้แสดงผลกราฟฟิกของ Unity ที่ผู้พัฒนาได้สร้างเอาไว้ เช่น prefabs\CIreply{คืออะไร} ต่างๆ

\subsection{Controller}
Controller จะอยู่ทั้ง 2 ฝั่ง คือทั้ง Unity และ หน้าเว็ป\CIreply{คืออะไร} โดย Controller ฝั่งหน้าเว็ปจะเป็นการรอให้ผู้ใช้
